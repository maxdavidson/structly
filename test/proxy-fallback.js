...
import {
  struct, array, tuple, bitfield, uint8,
  createProxy as createProxyRaw,
} from '../';

function createProxy(type, buffer, offset) {
  return createProxyRaw(type, buffer, offset, false);
}
